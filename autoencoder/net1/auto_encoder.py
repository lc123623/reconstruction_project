...
with tf.device('/cpu:0'):
	train_set=os.path.join(folder_of_dataset,'train.tfrecords')
	test_set=os.path.join(folder_of_dataset,'test.tfrecords')
...
writer=tf.summary.FileWriter(folder_to_save_log,sess.graph)
